...
$app->post('/api/MicrosoftEmotionAPI/getVideoRecognitionStatus', function ($request, $response, $args) {
    ...
    if(empty($post_data['args']['objectId'])) {
    ...
    $query_str = $settings['api_url'] . 'operations/'.$post_data['args']['objectId'];
